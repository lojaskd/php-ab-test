...
use LojasKD\ABTest\PHP\Test;

$my_test = new Test('headline', true); // remove TRUE to turn on GA tracking and maintain variation

$my_test->addVariation('logos', '99% of people are concerned about fluffy bunnies.');
$my_test->addVariation('ethos', 'Fluffy bunnies deserve to be protected.');
$my_test->addVariation('pathos', 'Fluffy bunnies are cute and snuggly.');
...
<head>
    ...
    <script type="text/javascript">
      var _gaq = _gaq || [];
      _gaq.push(['_setAccount', 'UA-91310476-1']);
